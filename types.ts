...
export type AppTheme = 'ice' | 'dark' | 'white' | 'pink';
...
export const TRANSLATIONS: any = {
  en: {
    ...
    examHowAddMaterial: "How do you want to add material?",
    examModeFullList: "Full list of tickets",
    examModeFullListDesc: "AI will generate a list of exam tickets by subject. You can generate a note for each ticket when you open it.",
    examModeReadySummary: "Ready-made summary",
    examModeReadySummaryDesc: "Paste your summary; AI will split it into themes and create tickets with notes.",
    examModePasteList: "Paste list of questions",
    examModePasteListDesc: "You already have a list of questions — paste and we'll parse it.",
    examHowManyTickets: "How many tickets?",
    examGenerateList: "Generate list",
    examPasteSummary: "Paste your summary (conspect)...",
    examSplitIntoThemes: "Split into how many themes?",
    examGranularity: "Granularity",
    examGranularityFine: "Fine (many small topics)",
    examGranularityMedium: "Medium",
    examGranularityCoarse: "Coarse (few broad topics)",
    examSplitAndCreate: "Split and create tickets",
    ...
    authExistsSwitchToLogin: "This username is already registered. Use the Log In tab to sign in.",
  ...
  ru: {
    ...
    examHowAddMaterial: "Как добавить материал?",
    examModeFullList: "Полный список билетов",
    examModeFullListDesc: "ИИ сформирует список билетов по предмету. Конспект к каждому билету можно сгенерировать при открытии.",
    examModeReadySummary: "Готовый конспект",
    examModeReadySummaryDesc: "Вставьте конспект — ИИ разобьёт его на темы и создаст билеты с конспектами.",
    examModePasteList: "Вставить список вопросов",
    examModePasteListDesc: "У вас уже есть список вопросов — вставьте текст, мы распарсим.",
    examHowManyTickets: "Сколько билетов сгенерировать?",
    examGenerateList: "Сгенерировать список",
    examPasteSummary: "Вставьте ваш конспект...",
    examSplitIntoThemes: "На сколько тем разбить?",
    examGranularity: "Гранулярность",
    examGranularityFine: "Мелко (много узких тем)",
    examGranularityMedium: "Средне",
    examGranularityCoarse: "Крупно (мало общих тем)",
    examSplitAndCreate: "Разбить и создать билеты",
    ...
    authExistsSwitchToLogin: "Этот логин уже зарегистрирован. Войдите под ним (вкладка «Вход»).",
